...
query = ("INSERT INTO balance_sheet_detail(stock_id,Mon_Year,Equity_Share_Capital,Total_Share_Capital,Reserves_and_Surplus,Total_Reserves_and_Surplus,Money_Received_Against_Share_Warrants,Total_Shareholders_Funds,Equity_Share_Application_Money,Long_Term_Provisions,Total_NonCurrent_Liabilities,Trade_Payables,Other_Current_Liabilities,Short_Term_Provisions,Total_Current_Liabilities,Total_Capital_And_Liabilities,Tangible_Assets,Intangible_Assets,Capital_WorkInProgress,Fixed_Assets,NonCurrent_Investments,Deferred_Tax_Assets_Net,Long_Term_Loans_And_Advances,Other_NonCurrent_Assets,Total_NonCurrent_Assets,Current_Investments,Inventories,Trade_Receivables,Cash_And_Cash_Equivalents,Short_Term_Loans_And_Advances,OtherCurrentAssets,Total_Current_Assets,Total_Assets,Contingent_Liabilities,Capital_Goods,Expenditure_In_Foreign_Currency,Dividend_Remittance_In_Foreign_Currency,FOB_Value_Of_Goods,Other_Earnings,Bonus_Equity_Share_Capital,Non_Current_Investments_Quoted_Market_Value,Non_Current_Investments_Unquoted_Book_Value,Current_Investments_Quoted_Market_Value,Current_Investments_Unquoted_Book_Value)"
	"VALUES (6066,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)"
	)
...
for i in range(1,6):
	...
	var38 = transposed[i][38]
	var39 = transposed[i][39]
	var40 = transposed[i][40]
	var41 = transposed[i][41]
	var42 = transposed[i][42]
	cursor.execute(query,(var0,var1,var2,var3,var4,var5,var6,var7,var8,var9,var10,var11,var12,var13,var14,var15,var16,var17,var18,var19,var20,var21,var22,var23,var24,var25,var26,var27,var28,var29,var30,var31,var32,var33,var34,var35,var36,var37,var38,var39,var40,var41,var42))
