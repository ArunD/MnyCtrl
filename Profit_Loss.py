...
query = ("INSERT INTO profit_loss_detail(stock_id,Mon_Year,Revenue_From_Operations_Gross,Revenue_From_Operations_Net,Total_Operating_Revenues,Other_Income,Total_Revenue,Changes_In_Inventories_Of_FG_WIP_And_StockIn_Trade,Employee_Benefit_Expenses,Depreciation_And_Amortisation_Expenses,Other_Expenses,Total_Expenses,ProfitLoss_Before_Exceptional_ExtraOrdinary_Items_And_Tax,Exceptional_Items,ProfitLoss_Before_Tax,Current_Tax,Less_MAT_Credit_Entitlement,Deferred_Tax,Total_Tax_Expenses,ProfitLoss_After_Tax_And_Before_ExtraOrdinary_Items,ProfitLoss_From_Continuing_Operations,ProfitLoss_For_The_Period,Basic_EPS_Rs,Diluted_EPS_Rs,Equity_Share_Dividend,Tax_On_Dividend,Equity_Dividend_Rate_percent)"
	"VALUES (6066,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)"
	)
...
#page = requests.get('http://www.moneycontrol.com/financials/saskencommunicationtechnologies/profit-lossVI/SCT01#SCT01')
...
for i in range(1,6):
	...
	cursor.execute(query,(var0,var1,var2,var3,var4,var5,var6,var7,var8,var9,var10,var11,var12,var13,var14,var15,var16,var17,var18,var19,var20,var21,var22,var23,var24,var25))
